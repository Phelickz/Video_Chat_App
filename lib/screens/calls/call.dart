...
import 'package:video_chat/utils/settings.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  void _addAgoraEventHandlers() {
    ...
    AgoraRtcEngine.onUserOffline = (int uid, int reason) {
      _callService.endCall(call: widget.call);
      setState(() {
  ...
  handleReceiverHangUp() async {
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      final uid = await Provider.of<AuthenticationState>(context, listen: false)
          .currentUserId();
      _streamSubscription =
          _callService.callStream(uid: uid).listen((DocumentSnapshot doc) {
        switch (doc.data) {
          case null:
